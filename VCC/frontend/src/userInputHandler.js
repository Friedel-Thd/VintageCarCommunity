...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (bodyElement.classList.contains("mainpage")) {
         ...
         */
        (_a = document.getElementById('registerForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                ...
                const response = yield fetch('http://localhost:3000/nextID');
                const data = yield response.json();
                const nextFreeID = data.nextFreeID;
                //DEBUG
                //console.log(data);
                //console.log(nextFreeID);
                let newUser = Nutzer.createUser(nextFreeID, userData.email, userData.password, userData.firstName, userData.lastName, userData.phonenumber, userData.city, userData.plz, userData.street, userData.hnr);
                //DEBUG
                //console.log(newUser);
                ...
                try {
                    ...
                    let response = yield fetch('http://localhost:3000/register', {
                        method: 'POST',
                        headers: {
         ...
         * @param {Event} event - The submit event.
         */
        (_b = document.getElementById('loginForm')) === null || _b === void 0 ? void 0 : _b.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                let formData = new FormData(event.target);
                let data = {};
     ...
     */
         ...
         */
        (_c = document.getElementById('stellplatzSucheForm')) === null || _c === void 0 ? void 0 : _c.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                ...
                console.log(data);
                try {
                    const response = yield fetch('http://localhost:3000/stellplatzsuche', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        ...
                        const selectedCity = document.getElementById('stadtSelect');
                        ...
                        let stellplatzinfo = yield response.json();
         ...
         */
        document.getElementById('stellplatzSucheDetailForm').addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                ...
                const kategorieid = elementWithAttribute === null || elementWithAttribute === void 0 ? void 0 : elementWithAttribute.getAttribute('data-kategorieid');
                const requestBody = {
                    kategorieid: kategorieid,
                    loggedInUser: loggedInUser
                };
                try {
                    const response = yield fetch('http://localhost:3000/sendAngebotsanfrage', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
         ...
         */
        document.getElementById('angeboteVerwaltenButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    let response = yield fetch('http://localhost:3000/getAngebote', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        let angebote = yield response.json();
         ...
         */
        document.getElementById('angebotAnnehmenAblehnenForm').addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('delete-button')) {
                // get angebotID
                const form = event.target;
                const elementWithAttribute = form.querySelector('[class="detail-result"]');
                const angebotid = elementWithAttribute === null || elementWithAttribute === void 0 ? void 0 : elementWithAttribute.getAttribute('data-angebotid');
                //console.log(angebotid);
                try {
                    let response = yield fetch('http://localhost:3000/deleteAngebot', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
        ...
        document.getElementById('angebotAnnehmenAblehnenForm').addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                ...
                const elementWithAttribute = form.querySelector('[class="detail-result"]');
                const angebotid = elementWithAttribute === null || elementWithAttribute === void 0 ? void 0 : elementWithAttribute.getAttribute('data-angebotid');
                const fahrzeugMarke = form.querySelector('[id="angebotAnnehmenMarkeText"]').value;
                const fahrzeugModell = form.querySelector('[id="angebotAnnehmenModellText"]').value;
                const requestBody = {
                    angebotid: angebotid,
                ...
                try {
                    let response = yield fetch('http://localhost:3000/acceptAngebot', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        ...
                        document.getElementById('angebotAnnehmenAblehnenErgebnis').innerText = ' ';
                        try {
                            let response = yield fetch('http://localhost:3000/deleteAcceptedAngebot', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
         ...
         */
        (_d = document.getElementById('angebotAnnehmenAblehnenBackButton')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', function () {
            document.getElementById('angeboteVerwaltenForm').style.display = 'block';
            document.getElementById('angebotAnnehmenAblehnenForm').style.display = 'none';
            document.getElementById('angebotAnnehmenAblehnenErgebnis').innerText = ' ';
        });
         ...
         */
        document.getElementById('fahrzeugeVerwaltenButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                document.getElementById('title').style.display = 'none';
                document.getElementById('welcome').style.display = 'none';
                document.getElementById('stellplatzSuchenButton').style.display = 'none';
                ...
                try {
                    const response = yield fetch('http://localhost:3000/getFahrzeugInfo', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        let fahrzeugListe = yield response.json();
         ...
         * @param {Event} event - The submit event
         */
        document.getElementById('fahrzeugVerwaltenForm').addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                console.log("test");
                let formData = new FormData(event.target);
                ...
                try {
                    const response = yield fetch('http://localhost:3000/setFahrzeugInfo', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
     ...
     */
        ...
        // Lager verwalten ---------------------
        document.getElementById('lagerVerwaltenButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                document.getElementById('title').style.display = 'none';
                document.getElementById('welcome').style.display = 'none';
                ...
                try {
                    console.log(JSON.stringify(loggedInUser));
                    let response = yield fetch('http://localhost:3000/getLagerinfo', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        ...
                        document.getElementById('lagerDatenInfoHausnummer').value = lagerhalter.getStorage().getHNR();
                        document.getElementById('lagerDatenInfoPostleitzahl').value = lagerhalter.getStorage().getPLZ();
                        document.getElementById('lagerDatenInfoStrasse').value = lagerhalter.getStorage().getStrasse();
                        document.getElementById('lagerDatenInfoServicezeiten').value = lagerhalter.getStorage().getServiceZeiten();
                        document.getElementById('stadtSelect').value = lagerhalter.getStorage().getStadt();
                        document.getElementById('markenSelect').value = lagerhalter.getStorage().getSpezHersteller();
                    }
                    else {
         ...
         * @param {Event} event - The click event
         */
        (_e = document.getElementById('lagerVerwaltenBackButton')) === null || _e === void 0 ? void 0 : _e.addEventListener('click', function () {
            document.getElementById('title').style.display = 'block';
            document.getElementById('welcome').style.display = 'block';
         ...
         * @param {Event} event - The submit event
         */
        (_f = document.getElementById('lagerVerwaltenForm')) === null || _f === void 0 ? void 0 : _f.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                let formData = new FormData(event.target);
                let data = {};
                ...
                console.log(requestBody);
                try {
                    const response = yield fetch('http://localhost:3000/setLagerinfo', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
         ...
         */
        document.getElementById('zusatzservicesVerwaltenButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                document.getElementById('title').style.display = 'none';
                document.getElementById('welcome').style.display = 'none';
                document.getElementById('stellplaetzeVerwaltenButton').style.display = 'none';
                ...
                try {
                    console.log(JSON.stringify(loggedInUser));
                    let response = yield fetch('http://localhost:3000/getServices', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        let serviceInfo = yield response.json();
         ...
         * @param {Event} event - The submit event
         */
        (_g = document.getElementById('neuerServiceForm')) === null || _g === void 0 ? void 0 : _g.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                let formData = new FormData(event.target);
                let data = {};
                ...
                console.log(requestBody);
                try {
                    const response = yield fetch('http://localhost:3000/newService', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
         ...
         */
        document.getElementById('neuerServiceButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                event.preventDefault();
         ...
         */
        (_h = document.getElementById('zusatzVerwaltenBackButton')) === null || _h === void 0 ? void 0 : _h.addEventListener('click', function () {
            document.getElementById('title').style.display = 'block';
            document.getElementById('welcome').style.display = 'block';
            document.getElementById('stellplaetzeVerwaltenButton').style.display = 'block';
            document.getElementById('zusatzservicesVerwaltenButton').style.display = 'block';
         ...
         */
        (_j = document.getElementById('neuerServiceBackButton')) === null || _j === void 0 ? void 0 : _j.addEventListener('click', function () {
            document.getElementById('title').style.display = 'block';
            document.getElementById('welcome').style.display = 'block';
            document.getElementById('stellplaetzeVerwaltenButton').style.display = 'block';
            document.getElementById('zusatzservicesVerwaltenButton').style.display = 'block';
         ...
         */
        document.getElementById('lagerhalterAnfragenVerwaltenButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                document.getElementById('title').style.display = 'none';
                document.getElementById('welcome').style.display = 'none';
                document.getElementById('stellplaetzeVerwaltenButton').style.display = 'none';
                ...
                try {
                    console.log(JSON.stringify(loggedInUser));
                    let response = yield fetch('http://localhost:3000/getUniqueAnfragen', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        let anfragen = yield response.json();
         ...
         * @param {Event} event - The submit event
         */
        document.getElementById('lagerhalterAnfrageDetailForm').addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('delete-button')) {
                // get AnfrageID
                const form = event.target;
                const elementWithAttribute = form.querySelector('[class="detail-result"]');
                const anfrageid = elementWithAttribute === null || elementWithAttribute === void 0 ? void 0 : elementWithAttribute.getAttribute('data-anfrageid');
                //console.log(anfrageid);
                try {
                    let response = yield fetch('http://localhost:3000/deleteAnfrage', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
        ...
        document.getElementById('lagerhalterAnfrageDetailForm').addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                ...
                const elementWithAttribute = form.querySelector('[class="detail-result"]');
                const anfrageid = elementWithAttribute === null || elementWithAttribute === void 0 ? void 0 : elementWithAttribute.getAttribute('data-anfrageid');
                const anfrageInhalt = form.querySelector('[id="anfrageAntwortText"]').value;
                const requestBody = {
                    anfrageid: anfrageid,
                ...
                try {
                    let response = yield fetch('http://localhost:3000/sendAngebot', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        ...
                        document.getElementById('lagerhalterAnfrageDetailErgebnis').innerText = ' ';
                        document.getElementById('lagerhalterAnfrageResultForm').innerText = ' ';
                        document.getElementById('anfrageAntwortText').value = '';
                        try {
                            let response = yield fetch('http://localhost:3000/deleteAnfrage', {
                                method: 'POST',
                                headers: {
         ...
         */
        (_k = document.getElementById('lagerhalterAnfrageDetailBackButton')) === null || _k === void 0 ? void 0 : _k.addEventListener('click', function () {
            document.getElementById('lagerhalterAnfragenVerwaltenForm').style.display = 'block';
            document.getElementById('lagerhalterAnfrageDetailForm').style.display = 'none';
            document.getElementById('lagerhalterAnfrageDetailErgebnis').innerText = ' ';
        });
     ...
     */
         ...
         */
        document.getElementById('werkstattVerwaltenButton').addEventListener('click', function () {
            return __awaiter(this, void 0, void 0, function* () {
                document.getElementById('title').style.display = 'none';
                document.getElementById('welcome').style.display = 'none';
                ...
                yield fetchStaedte();
                try {
                    let response = yield fetch('http://localhost:3000/getWerkstattinfo', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                    ...
                    if (response.ok) {
                        ...
                        document.getElementById('werkstattInfoName').value = werkstatt.getWerkstattname();
                        document.getElementById('werkstattInfoArbeiten').value = werkstatt.getAngeboteneArbeiten();
                        document.getElementById('werkstattInfoPlz').value = werkstatt.getPlz();
                        document.getElementById('werkstattInfoStr').value = werkstatt.getStrasse();
                        document.getElementById('werkstattInfoHnr').value = werkstatt.getHausnummer();
                        document.getElementById('stadtSelect').value = werkstatt.getStadt();
                        document.getElementById('markenSelect').value = werkstatt.getSpezHersteller();
                    }
                    else {
         ...
         */
        (_l = document.getElementById('werkstattVerwaltenForm')) === null || _l === void 0 ? void 0 : _l.addEventListener('submit', (event) => __awaiter(this, void 0, void 0, function* () {
            event.preventDefault();
            if (event.submitter && event.submitter.classList.contains('action-button')) {
                let formData = new FormData(event.target);
                let data = {};
                ...
                console.log(requestBody);
                try {
                    const response = yield fetch('http://localhost:3000/setWerkstattinfo', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
 ...
 */
function fetchMarken() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch('http://localhost:3000/marken');
            const data = yield response.json();
 ...
 */
function fetchStaedte() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch('http://localhost:3000/staedte');
            const data = yield response.json();
            const staedte = data.staedte;
            const stadtSelect = document.getElementById('stadtSelect');
            staedte.forEach((staedt) => {
                const option = document.createElement('option');
                option.value = staedt;
...
function fahrzeugSucheErgebnisAuswahl(event) {
    ...
    document.getElementById('fahrzeugMarke').value = marke;
    document.getElementById('fahrzeugModell').value = modell;
 ...
 * @param {Event} event - The click event.
 */
function stellplatzSucheErgebnisAuswahl(event) {
    return __awaiter(this, void 0, void 0, function* () {
        event.preventDefault();
        const auswahl = event.currentTarget;
        const kategorieid = auswahl.getAttribute('data-kategorieid');
        try {
            const response = yield fetch('http://localhost:3000/getCategoryDetailinfo', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
 ...
 */
function stellplatzkatgorieGetLagerbedingungen(input) {
    console.log(input);
 ...
 * @param {Event} event - The click event.
 */
function angebotsAnfragenAuswahl(event) {
    return __awaiter(this, void 0, void 0, function* () {
        event.preventDefault();
        const auswahl = event.currentTarget;
        ...
        //console.log(anfrageid);
        try {
            const response = yield fetch('http://localhost:3000/getAnfrageDetailinfo', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
function angebotAuswahl(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //console.log(angebotid);
        try {
            const response = yield fetch('http://localhost:3000/getAngebotDetailinfo', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
